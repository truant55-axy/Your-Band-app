<div align="center">
<img width="1366" height="5174" alt="Image" src="https://github.com/user-attachments/assets/e608d799-08c5-42b6-903e-602cb1239614" />
</div>

# Your Band - Personal Mental Wellness Companion

**Your Band** is an AI-powered mental health application designed to bridge the gap between invisible emotions and tangible support. By integrating physiological data with an empathetic AI companion, we transform "numbers" into "emotions," providing personalized care for young adults.

View our live app: https://your-band.netlify.app/
...
3. Run the app:
   `npm run dev`
4. On mobile, open `http://<your-computer-IP>:3000` (both devices on the same network) so the dev server that now listens on all hosts can finish loading.
